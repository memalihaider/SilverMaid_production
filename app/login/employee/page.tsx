...
import { User, Eye, EyeOff, ArrowLeft, Lock, Mail, Loader2, Sparkles, ChevronRight, Clock, Calendar, FileText } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-900/80 border border-zinc-800/50 rounded-full">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em]">Personal Access</span>
          </div>
        </div>
        ...
        <div className="bg-[#0f0f0f]/80 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-500 text-sm">Access your jobs, schedule and payments</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-8">
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              <Clock className="w-4 h-4 text-zinc-500 group-hover/item:text-white transition-colors" />
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Attendance</span>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              <Calendar className="w-4 h-4 text-zinc-500 group-hover/item:text-white transition-colors" />
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Leave</span>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              <FileText className="w-4 h-4 text-zinc-500 group-hover/item:text-white transition-colors" />
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Payslips</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] ml-1">Staff ID (Email)</label>
        ...
        <div className="mt-10 text-center">
          <p className="text-[10px] font-black text-zinc-700 uppercase tracking-[0.4em]">
            © 2026 SILVER MAID ▪ STAFF RESOURCES
          </p>
        </div>
      </div>
    </div>
