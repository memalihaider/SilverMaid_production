...
import { Eye, EyeOff, ArrowLeft, Building, Lock, Mail, Loader2, Sparkles, ChevronRight, Briefcase, FileText, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-zinc-800/10 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-zinc-900/20 rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-900/80 border border-zinc-800/50 rounded-full">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em]">Partner Access</span>
          </div>
        </div>
        ...
        <div className="bg-[#0f0f0f]/80 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-500 text-sm">Manage your service requests and tracking</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-8">
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              ...
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Jobs</span>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              <FileText className="w-4 h-4 text-zinc-500 group-hover/item:text-white transition-colors" />
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Invoices</span>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 p-3 rounded-2xl flex flex-col items-center gap-1 group/item hover:border-zinc-700 transition-colors">
              <MessageCircle className="w-4 h-4 text-zinc-500 group-hover/item:text-white transition-colors" />
              <span className="text-[9px] font-black text-zinc-600 uppercase tracking-tighter">Support</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] ml-1">Client Email</label>
              <div className="relative group/input">
                ...
                <input
                  ...
                  placeholder="client@silvermaid.ae"
                  required
                />
              </div>
            </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-[10px] font-black text-zinc-700 uppercase tracking-[0.4em]">
            © 2026 SILVER MAID ▪ GLOBAL SERVICES
          </p>
        </div>
      </div>
    </div>
