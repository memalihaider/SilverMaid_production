              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 text-lg font-medium leading-relaxed">
                    At Silver Maid UAE, we prioritize your indoor air quality by removing dust, allergens, and mold from your ventilation system. Our NADCA-inspired cleaning process ensures that every corner of your ductwork is scrubbed clean and sanitized using hospital-grade disinfectants.
                  </p>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-primary uppercase tracking-[0.4em] mb-4">The Silver Maid Edge</h2>
